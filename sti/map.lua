...
function Map:initWorldCollision(world)
	...
	local function addObjectToWorld(objshape, vertices, properties)
		local shape
		...
		-- hack: set fixture user data with the properties of tile or object
	...
	local function calculateObjectPosition(object, tile)
		...
		if o.shape == "rectangle" then
			...
			addObjectToWorld(o.shape, vertices, object.properties)
		elseif o.shape == "ellipse" then
			...
			for _, triangle in ipairs(triangles) do
				addObjectToWorld(o.shape, triangle, object.properties)
			end
...
function Map:drawWorldCollision(collision)
	...
	for _, obj in ipairs(collision) do
		local pts = pack(collision.body:getWorldPoints(obj.shape:getPoints()))
		if(table.getn(pts)>=3) then
		framework.polygon("line", unpack(pts))
		else 
			-- print(unpack(pts))
			-- framework.line(unpack(pts))
		end
	end
end
